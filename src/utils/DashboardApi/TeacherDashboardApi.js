...
const periodsubjectdatateacher = {
   heading:[
    {
        head:"Periods",
    },
...
const salaryInformationteacher = {
    currentstatus:"salary has been credited to your account",
    salaryinfodetails:[
        {
            month:"Dec",
            date:"22-12-2022",
